  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Conceptos clave del plan de mercadeo
        p.mb-4 Identificar algunas palabras relacionadas con el plan de mercadeo digital que resultan clave para el diseño de un plan de mercadeo digital.
